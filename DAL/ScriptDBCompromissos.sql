...
(ID INT IDENTITY(1,1) NOT NULL CONSTRAINT PK_TB_TIPO_COMPROMISSO PRIMARY KEY,  TX_DESCRICAO VARCHAR (50) NOT NULL)
go
...
(ID INT IDENTITY(1,1) NOT NULL CONSTRAINT PK_TB_COMPROMISSO PRIMARY KEY,
 ID_TIPO_COMPROMISSO INT NOT NULL CONSTRAINT FK_COMP_TB_TIPO_COMPROMISSO FOREIGN KEY REFERENCES TB_TIPO_COMPROMISSO(ID),
...
INSERT INTO TB_COMPROMISSO (ID_TIPO_COMPROMISSO, TX_DESCRICAO, TX_LOCALIZACAO, DT_INICIO, DT_TERMINO,FL_VISIVEL)
VALUES (1, 'Aula 01/07/2021', 'Aula Remota Teams', '2021-07-01', '2021-07-01', 1)
GO 
--Não usaremos essas tabelas, mas fica como exemplo de vinculação do compromisso com os participantesCREATE TABLE TB_COMPROMISSO_PARTICIPANTE
( ID_COMPROMISSO INT NOT NULL CONSTRAINT FK_CP_COMPROMISSSO FOREIGN KEY REFERENCES TB_COMPROMISSO(ID),
 ID_PARTICIPANTE INT NOT NULL CONSTRAINT FK_CP_PARTICIPANTE FOREIGN KEY REFERENCES TB_PARTICIPANTE(ID))

GO

CREATE TABLE TB_COMPROMISSO_IMAGENS
(ID int IDENTITY(1,1) NOT NULL,
 ID_COMPROMISSO int NOT NULL CONSTRAINT FK_IM_COMPROMISSO FOREIGN KEY REFERENCES TB_COMPROMISSO(ID),
